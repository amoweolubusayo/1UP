...
const Hero = () => {
  return (
    <div className="grid h-screen place-items-center">
      <div className="relative h-56 bg-white-100 sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2">
        <img
      ...
      <div className="relative mx-auto max-w-md px-4 py-12 sm:max-w-7xl sm:px-6 sm:py-20 md:py-28 lg:px-8 lg:py-32">
        <div className="md:ml-auto md:w-1/2 md:pl-10">
          ...
          <p className="mt-3 text-lg text-black-300">
            Welcome to Primero! Primero is the first decentralized web3 platform
            and marketplace for online learning and teaching that revolutionizes
            access to courses and skills in developing countries in Africa and
            Latin America.
          </p>
          <p className="mt-3 text-lg text-black-300">
            Join Primero to create the first web3 learning and teaching
            ecosystem that will enable future generations to prosper and develop
            in Africa and Latin America. Together, WE CAN!
          </p>
          <div className="mt-8">
