              ...
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                {features.map((feature) => (
                  <div key={feature.name} className="pt-6">
                    ...
                    <div className="-mt-2">
                    <div>
                    <div className="inline-flex items-center justify-center rounded-md bg-indigo-500 p-3 text-white shadow-lg">
                  ...
                  <div className="md:ml-auto md:w-1/2 md:pl-10">
                    ...
                    <div className="mt-8">
                      ...
                      <Link href="/all-courses">
                        <a
                          className="inline-flex items-center justify-center px-5 py-3 border border-transparent bg-indigo-500 text-base font-medium rounded-md text-white bg-yellow"
                        >
                         Take a Course
                        </a>
                        </Link>
